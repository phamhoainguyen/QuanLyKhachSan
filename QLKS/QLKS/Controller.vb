...
#Region "Danh sách các thông báo"
        ...
        Private _msgNotPermission As String = "You are not allowed to use this functionality!"
        Private _msgExitWarning As String = "Do you exit certainly?"
        Private _msgLoginSuccess As String = "Login succeed!"
        Private _msgLoginFail As String = "Login fail!" + vbNewLine + "Incorrect account or password."
        Private _msgTitleNotify As String = "Notify"
        Private _msgErrorLoginTitle As String = "Error login"
        Private _msgEmptyUsername As String = "User name can not be blank!"
        Private _msgEmptyPassword As String = "Password can not be blank!"
        Private _msgAddRoomSuccess As String = "Create room catalog successfully!"
        Private _msgAddRoomFail As String = "Create room catalog unsuccessfully!"
        Private _msgEditRoomSuccess As String = "Edit room infomation successfully!"
        Private _msgEditRoomFail As String = "Edit room infomation unsuccessfully!"
        Private _msgDeleteRoomSuccess As String = "Delete room successfully!"
        Private _msgDeleteRoomFail As String = "Delete room unsuccessfully!"
        Private _msgTitleWarning As String = "Warning"
        Private _msgDeleteWarning As String = "Do you delete certainly"
        Private _msgAddRoomType As String = "Add room type"
        Private _msgAddRoom As String = "Create room catalog"
        Private _txtRoomID As String = "Room ID"
        Private _txtRoomName As String = "Room name"
        Private _txtRoomTypeName As String = "Room type name"
        Private _txtRoomTypeID As String = "Room type ID"
        Private _txtPriceUnit As String = "Price unit"
        Private _txtNote As String = "Note"
        Private _txtCMND As String = "Identity card"
        Private _txtAddress As String = "Address"
        Private _txtStartDate As String = "Begin day"
        Private _txtEndDate As String = "End date"
        Private _txtCustomerID As String = "Customer ID"
        Private _txtCustomerName As String = "Customer name"
        Private _txtCustomerTypeID As String = "Customer type ID"
        Private _txtCustomerTypeName As String = "Customer type name"
#End Region
